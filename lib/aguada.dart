...
class aguada extends StatefulWidget {
  const aguada({Key? key}) : super(key: key);

  @override
  State<aguada> createState() => _aguadaState();
}

class _aguadaState extends State<aguada> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://media.istockphoto.com/id/183375277/photo/view-from-aguada-fort.jpg?s=612x612&w=0&k=20&c=JnhrBYGsX_zLYZL_Xvnp_EQEOA0SWR96HLiHlfoxOL4='),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
