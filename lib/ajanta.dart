...
class ajanta extends StatefulWidget {
  const ajanta({Key? key}) : super(key: key);

  @override
  State<ajanta> createState() => _ajantaState();
}
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://1.bp.blogspot.com/-yuYcOu7DCD8/YMcvWPFBE4I/AAAAAAAAVz4/ExPVsUWPVWgNNb6zcdxmGxG6szLYZO6JACLcBGAsYHQ/s645/Ajanta_Cave19.jpg'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
