...
class alleppey extends StatefulWidget {
  const alleppey({Key? key}) : super(key: key);

  @override
  State<alleppey> createState() => _alleppeyState();
}

class _alleppeyState extends State<alleppey> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://media.istockphoto.com/id/1281059200/photo/sunset-color-of-clouds-above-sea-water.jpg?s=612x612&w=0&k=20&c=uWsBlyx9i4DLIuPT8oPV4nltnFScAMozyRaBrFsRlNY='),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
