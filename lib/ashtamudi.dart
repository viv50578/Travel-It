...
class ashtamudi extends StatefulWidget {
  const ashtamudi({Key? key}) : super(key: key);

  @override
  State<ashtamudi> createState() => _ashtamudiState();
}

class _ashtamudiState extends State<ashtamudi> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/07/28/34/13/ashtamudi-lake.jpg?w=1200&h=1200&s=1'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
