...
class ayodhya extends StatefulWidget {
  const ayodhya({Key? key}) : super(key: key);

  @override
  State<ayodhya> createState() => _ayodhyaState();
}

class _ayodhyaState extends State<ayodhya> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.news18.com/ibnlive/uploads/2020/08/1596532888_ram-mandir-in-ayodhya-photos-10.jpg?impolicy=website&width=0&height=0'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
