...
class basilica extends StatefulWidget {
  const basilica({Key? key}) : super(key: key);

  @override
  State<basilica> createState() => _basilicaState();
}

class _basilicaState extends State<basilica> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://res.cloudinary.com/purnesh/image/upload/f_auto/v1580895915/basilica-of-bom-jesus.jpg'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
