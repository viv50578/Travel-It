...
class ellora extends StatefulWidget {
  const ellora({Key? key}) : super(key: key);

  @override
  State<ellora> createState() => _elloraState();
}
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.travelandleisureindia.in/wp-content/uploads/2022/08/16121746/Untitled-design-2022-08-16T121551.697.jpg?tr=w-1200,h-900'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
