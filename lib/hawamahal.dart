...
class hawamahal extends StatefulWidget {
  const hawamahal({Key? key}) : super(key: key);

  @override
  State<hawamahal> createState() => _hawamahalState();
}
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.pexels.com/photos/894443/pexels-photo-894443.jpeg?cs=srgb&dl=pexels-anuja-vidhate-894443.jpg&fm=jpg'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
