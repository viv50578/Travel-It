...
class mahabaleshwar extends StatefulWidget {
  const mahabaleshwar({Key? key}) : super(key: key);

  @override
  State<mahabaleshwar> createState() => _mahabaleshwarState();
}

class _mahabaleshwarState extends State<mahabaleshwar> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://images.unsplash.com/photo-1579609424835-16beba97e3c2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bWFoYWJhbGVzaHdhcnxlbnwwfHwwfHw%3D&w=1000&q=80'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
