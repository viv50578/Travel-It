...
class mathura extends StatefulWidget {
  const mathura({Key? key}) : super(key: key);

  @override
  State<mathura> createState() => _mathuraState();
}

class _mathuraState extends State<mathura> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/42/52/ca/caption.jpg?w=300&h=300&s=1'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
