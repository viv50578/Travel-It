...
class wayanad extends StatefulWidget {
  const wayanad({Key? key}) : super(key: key);

  @override
  State<wayanad> createState() => _wayanadState();
}

class _wayanadState extends State<wayanad> {
  @override
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage(
              'https://fastly.4sqi.net/img/general/600x600/99245572_Ye94C0k7kE7Y3EjVfVSAUjRN5y88z-mcEAny3fAR8E8.jpg'),
          fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
